...
$(TARGET):  $(BIN)Mark.o $(BIN)Edge.o $(BIN)Vertex.o $(BIN)LGraph.o  $(BIN)Scanner.o  $(BIN)Dependencies.o $(BIN)Parser.o 
	g++ -std=c++11 $(BIN)Mark.o $(BIN)Edge.o $(BIN)Vertex.o $(BIN)LGraph.o $(BIN)Scanner.o $(BIN)Dependencies.o $(BIN)Parser.o main.cpp -o  $(TARGET)
